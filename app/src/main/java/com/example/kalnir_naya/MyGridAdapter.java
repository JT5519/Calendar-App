...
public class MyGridAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(DayNo == todayDay && displayMonth == todayMonth && displayYear == todayYear){
            view.setBackground(getContext().getResources().getDrawable(R.drawable.border3));
        }
        else if(displayMonth == currentMonth && displayYear==currentYear){
            //view.setBackgroundColor(getContext().getResources().getColor(R.color.white));
            view.setBackground(getContext().getResources().getDrawable(R.drawable.border));
        }
        else
        {
            //view.setBackgroundColor(Color.parseColor("#cccccc"));
            view.setBackground(getContext().getResources().getDrawable(R.drawable.border2));
        }
